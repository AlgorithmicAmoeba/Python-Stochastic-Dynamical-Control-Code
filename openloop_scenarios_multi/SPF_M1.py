...
ydists = numpy.array([scipy.stats.multivariate_normal(cov=params.R1), scipy.stats.multivariate_normal(cov=params.R1)])
...
SPF.init_filter(particles, params.ys1[0], cstr_filter)
...
for t in range(1, params.N):
    ...
    SPF.spf_filter(particles, params.us[t-1], params.ys1[t], cstr_filter)
