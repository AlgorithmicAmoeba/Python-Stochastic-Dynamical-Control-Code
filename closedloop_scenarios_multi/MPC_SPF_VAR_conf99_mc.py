...
def fun():
    ...
    params.us[0] = MPC.mpc_var(params.spfmeans[:, 0] - lin_models[ind].b, params.spfcovars[:, :, 0], horizon,
                               ...
                               cline,
                               params.QQ, params.RR, yspfix, usps[ind], 15000.0, 1000.0, params.Q, 9.21, True)
...
numpy.savetxt("spf_var99.csv", filteredResults, delimiter=",", fmt="%f")
numpy.savetxt("spf_var99_mc2.csv", xconcen, delimiter=",", fmt="%f")
